...
public class EditProfilAct extends AppCompatActivity {
    ImageView pic_photo_edit_profile,btn_add_new_photo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pic_photo_edit_profile = findViewById( R.id.pic_photo_edit_profile );
        ...
        reference.addListenerForSingleValueEvent( new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with( EditProfilAct.this ).load( dataSnapshot.child( "url_photo_profile" ).getValue().toString()).into( pic_photo_edit_profile );
                ...
                if (photo_location != null) {
                    ...
                    storageReference1.putFile( photo_location )
                        ...
                        public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                            //Berpindah act
                            Intent gotobackprofile = new Intent(EditProfilAct.this,My_ProfilAct.class);
        ...
        btn_back.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent gotomyeditprofileback = new Intent(EditProfilAct.this,My_ProfilAct.class);
                startActivity( gotomyeditprofileback );
            }
        } );
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
                ...
                .getData() != null)
        {
            ...
            Picasso.with(this).load( photo_location ).centerCrop().fit().into( pic_photo_edit_profile );
        }
    }
